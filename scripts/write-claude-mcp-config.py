...
"""Write a Claude Code .mcp.json config for the published Upwind Sentinel custom MCP collection."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate .mcp.json for Claude Code and the Upwind Sentinel custom MCP endpoint.")
