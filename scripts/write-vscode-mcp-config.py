...
"""Write a VS Code MCP config for the published Upwind Sentinel custom MCP collection."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate .vscode/mcp.json for the Upwind Sentinel custom MCP endpoint.")
